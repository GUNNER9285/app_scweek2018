...
public class Room2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRoom1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Room2Activity.this, Room1Activity.class);
                startActivity(intent);
            }
        });
        ...
        btnRoom2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Room2Activity.this, Room2Activity.class);
                startActivity(intent);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(result != null){
            if(result.getContents()==null){
                ...
                String url = "http://scweek61.herokuapp.com/inroom/"+result.getContents()+"/2";
